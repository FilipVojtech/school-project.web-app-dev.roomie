...
import { deleteEvent, updateEvent } from "@/app/(app)/calendar/_actions";
...
export default function EditEventForm({ data, frequencyOptions }: EditEventFormProps) {
    const router = useRouter();
    const { frequency, id, starts_on, title, repeating } = data;
    ...
    async function handleDelete() {
        ...
        // @ts-ignore
        if (result.reedirectTo) router.replace(result.redirectTo!);
    }
